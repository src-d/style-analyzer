...
style-analyzer project is [Affero GPL licensed](../LICENSE.md) and accepts contributions via GitHub pull requests. This document outlines some of the conventions on development workflow, commit message formatting, contact points, and other resources to make it easier to get your contribution accepted.
...
* GitHub [issues](https://github.com/src-d/style-analyzer/issues)\*
...
Pull Requests \(PRs\) are the main and exclusive way to contribute to the official style-analyzer project. In order for a PR to be accepted it needs to pass a list of requirements:
