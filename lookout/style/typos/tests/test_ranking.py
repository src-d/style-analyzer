...
class CandidatesRankerTest(unittest.TestCase):
    def test_custom_ranker(self):
        ...
        ranker.fit(custom_data[COLUMNS["CORRECT_TOKEN"]], custom_candidates_tokens,
    ...
    def test_ranker(self):
        ...
        ranker = CandidatesRanker()
        ranker.fit(data[COLUMNS["CORRECT_TOKEN"]], get_candidates_metadata(candidates),
