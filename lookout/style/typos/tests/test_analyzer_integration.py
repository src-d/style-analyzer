...
class AnalyzerIntegrationTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("sys.argv", command.split(" ")):
            launch_analyzer()
        command = ("analyzer run lookout.style.typos --db sqlite:///%s "
    ...
    def test_review(self):
        launch_server(
            "review",
            "tbd32214d1b08e09278f39c77979658cabde6c4d",
            "831442679ad04ebadad2b70a9f938fb0bc64d537",
            self.port, git_dir=self.jquery_dir)
        matches = re.search(r"IdTyposAnalyzer: (\d+) comments", "".join(self.logs))
