# Model report for file:///tmp/top-repos-quality-repos-_khy_2rc/express HEAD b4eb1f59d39d801d7365c86b04500f16faeb0b1c
...
| 8 | `  -1.reserved not in {,, var}<br>	∧ -1.roles not in {STRING}<br>	∧ -2.diff_offset ≥ 3<br>	∧ -4.label not in {<space>}<br>	∧ -4.roles not in {IDENTIFIER}<br>	∧ +1.reserved = }<br>	∧ +1.roles not in {STRING}<br>⇒ y = ⏎␣⁻␣⁻<br>Confidence: 0.986. Support: 257.` |
