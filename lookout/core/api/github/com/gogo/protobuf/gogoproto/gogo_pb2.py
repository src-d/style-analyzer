...
goproto_getters = _descriptor.FieldDescriptor(
  name='goproto_getters', full_name='gogoproto.goproto_getters', index=36,
...
goproto_stringer = _descriptor.FieldDescriptor(
  name='goproto_stringer', full_name='gogoproto.goproto_stringer', index=37,
...
verbose_equal = _descriptor.FieldDescriptor(
  name='verbose_equal', full_name='gogoproto.verbose_equal', index=38,
...
face = _descriptor.FieldDescriptor(
  name='face', full_name='gogoproto.face', index=39,
...
gostring = _descriptor.FieldDescriptor(
  name='gostring', full_name='gogoproto.gostring', index=40,
...
populate = _descriptor.FieldDescriptor(
  name='populate', full_name='gogoproto.populate', index=41,
...
stringer = _descriptor.FieldDescriptor(
  name='stringer', full_name='gogoproto.stringer', index=42,
...
onlyone = _descriptor.FieldDescriptor(
  name='onlyone', full_name='gogoproto.onlyone', index=43,
...
equal = _descriptor.FieldDescriptor(
  name='equal', full_name='gogoproto.equal', index=44,
...
description = _descriptor.FieldDescriptor(
  name='description', full_name='gogoproto.description', index=45,
...
testgen = _descriptor.FieldDescriptor(
  name='testgen', full_name='gogoproto.testgen', index=46,
...
benchgen = _descriptor.FieldDescriptor(
  name='benchgen', full_name='gogoproto.benchgen', index=47,
...
marshaler = _descriptor.FieldDescriptor(
  name='marshaler', full_name='gogoproto.marshaler', index=48,
...
unmarshaler = _descriptor.FieldDescriptor(
  name='unmarshaler', full_name='gogoproto.unmarshaler', index=49,
...
stable_marshaler = _descriptor.FieldDescriptor(
  name='stable_marshaler', full_name='gogoproto.stable_marshaler', index=50,
...
sizer = _descriptor.FieldDescriptor(
  name='sizer', full_name='gogoproto.sizer', index=51,
...
unsafe_marshaler = _descriptor.FieldDescriptor(
  name='unsafe_marshaler', full_name='gogoproto.unsafe_marshaler', index=52,
...
unsafe_unmarshaler = _descriptor.FieldDescriptor(
  name='unsafe_unmarshaler', full_name='gogoproto.unsafe_unmarshaler', index=53,
...
goproto_extensions_map = _descriptor.FieldDescriptor(
  name='goproto_extensions_map', full_name='gogoproto.goproto_extensions_map', index=54,
...
goproto_unrecognized = _descriptor.FieldDescriptor(
  name='goproto_unrecognized', full_name='gogoproto.goproto_unrecognized', index=55,
...
protosizer = _descriptor.FieldDescriptor(
  name='protosizer', full_name='gogoproto.protosizer', index=56,
...
compare = _descriptor.FieldDescriptor(
  name='compare', full_name='gogoproto.compare', index=57,
...
typedecl = _descriptor.FieldDescriptor(
  name='typedecl', full_name='gogoproto.typedecl', index=58,
...
messagename = _descriptor.FieldDescriptor(
  name='messagename', full_name='gogoproto.messagename', index=59,
...
nullable = _descriptor.FieldDescriptor(
  name='nullable', full_name='gogoproto.nullable', index=60,
...
embed = _descriptor.FieldDescriptor(
  name='embed', full_name='gogoproto.embed', index=61,
...
customtype = _descriptor.FieldDescriptor(
  name='customtype', full_name='gogoproto.customtype', index=62,
...
customname = _descriptor.FieldDescriptor(
  name='customname', full_name='gogoproto.customname', index=63,
...
jsontag = _descriptor.FieldDescriptor(
  name='jsontag', full_name='gogoproto.jsontag', index=64,
...
moretags = _descriptor.FieldDescriptor(
  name='moretags', full_name='gogoproto.moretags', index=65,
...
casttype = _descriptor.FieldDescriptor(
  name='casttype', full_name='gogoproto.casttype', index=66,
...
castkey = _descriptor.FieldDescriptor(
  name='castkey', full_name='gogoproto.castkey', index=67,
...
castvalue = _descriptor.FieldDescriptor(
  name='castvalue', full_name='gogoproto.castvalue', index=68,
...
stdtime = _descriptor.FieldDescriptor(
  name='stdtime', full_name='gogoproto.stdtime', index=69,
...
stdduration = _descriptor.FieldDescriptor(
  name='stdduration', full_name='gogoproto.stdduration', index=70,
