...
from . import service_analyzer_pb2 as service__analyzer__pb2
...
class AnalyzerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.NotifyReviewEvent = channel.unary_unary(
        ...
        request_serializer=event__pb2.ReviewEvent.SerializeToString,
        response_deserializer=service__analyzer__pb2.EventResponse.FromString,
        )
    self.NotifyPushEvent = channel.unary_unary(
        '/pb.Analyzer/NotifyPushEvent',
        request_serializer=event__pb2.PushEvent.SerializeToString,
        response_deserializer=service__analyzer__pb2.EventResponse.FromString,
        )
...
def add_AnalyzerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'NotifyReviewEvent': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=event__pb2.ReviewEvent.FromString,
          response_serializer=service__analyzer__pb2.EventResponse.SerializeToString,
      ),
      'NotifyPushEvent': grpc.unary_unary_rpc_method_handler(
          servicer.NotifyPushEvent,
          request_deserializer=event__pb2.PushEvent.FromString,
          response_serializer=service__analyzer__pb2.EventResponse.SerializeToString,
      ),
  }
